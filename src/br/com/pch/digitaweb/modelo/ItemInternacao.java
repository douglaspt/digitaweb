...
@Entity
@Table(name = "tbl_iteminternacao")
public class ItemInternacao {

	@Id
	@Column(name = "cod_guiaItemInternacao")
	private long id = (new GregorianCalendar().getTimeInMillis()+this.hashCode()/100000);
	
	@OneToOne
	@JoinColumn(name = "cod_guiaInternacao")
	...
	public String toString() {
		return "ItemInternacao [id=" + id + ", internacao=" + internacao + ", dataRealizacao=" + dataRealizacao
				+ ", tabela=" + tabela + ", item=" + item + ", quantidade=" + quantidade + ", viaAcesso=" + viaAcesso
				+ ", tecnicaUtilizada=" + tecnicaUtilizada + ", percentual=" + percentual + ", valor=" + valor
				+ ", descricao=" + descricao + "]";
	}	
